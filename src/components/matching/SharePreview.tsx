...
function scoreColor(score: number): string {
  ...
  if (score >= 40) {
    return "text-[var(--accent)] border-[rgba(214,177,111,0.35)]";
  }
      ...
      <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,#090b11_0%,#111623_45%,#090b11_100%)] p-4 shadow-[0_28px_70px_rgba(0,0,0,0.42)]">
        <div className="rounded-[1.6rem] border border-white/8 bg-black/15 p-4">
          <div className="text-center">
            ...
            <div className="mx-auto mt-3 h-px w-24 bg-gradient-to-r from-transparent via-[rgba(214,177,111,0.6)] to-transparent" />
          </div>

          <div className="mt-5 grid grid-cols-[0.92fr_auto_1.08fr] items-start gap-3">
            <div className="space-y-2">
              <p className="section-subtitle text-center">Reference</p>
              <div className="overflow-hidden rounded-[1.2rem] border border-[rgba(214,177,111,0.24)]">
                <img src={referenceImageUrl} alt="Reference" className="aspect-[4/5] h-full w-full object-cover" />
              </div>
            </div>

            <div className="pt-12">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[rgba(214,177,111,0.18)] text-xs font-bold text-[var(--accent)]">
                VS
              </div>
            </div>

            <div className="space-y-2">
              <p className="section-subtitle text-center">Your Look</p>
